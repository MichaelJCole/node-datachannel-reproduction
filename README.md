...
# vitest will run using this command:
#     "test": "ELECTRON_RUN_AS_NODE=1 electron node_modules/.bin/vitest"

# On the first run, the test will pass

# Hit 'enter' to re-run the tests using watch
# The test will fail thusly.

RERUN  x4

 ❯ src/main/test.test.js (0)
...
This repo was created using these commands:
...
# add the file src/main/test.test.js
```

Below is the readme that comes with electron-vite
